...
describe('Central de Atendimento ao Cliente TAT', () => {
    ...
    it('verifica o título da aplicação - teste', () => {
        cy.title()
    ...
    it('exibe mensagem de erro ao submeter o formulário com um email com formatação invalida', () => {
        ...
        cy.get('[id="open-text-area"]').type('Texto')
        cy.contains('button', 'Enviar').click()
    ...
    it('preenche e limpa os campos nome, sobrenome, email e telefone', () => {
        ...
        cy.get('[id="lastName"]')
            ...
            .should('have.value', '')
        cy.get('[id="email"]')
            .type('nunes@email.com')
            .should('have.value', 'nunes@email.com')
            .clear()
            .should('not.have.value')
        cy.get('#phone')
            .type('99998888')
            .should('have.value', '99998888')
            .clear()
            .should('not.have.value')
    })
